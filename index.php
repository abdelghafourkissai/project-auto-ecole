    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100">
                ...
                <a href="/auto-ecole/pages/courses.php?type=B" 
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100">
                ...
                <a href="/auto-ecole/pages/courses.php?type=A" 
                   class="inline-block px-6 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-colors text-sm">
                    En savoir plus
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100">
                ...
                <a href="/auto-ecole/pages/courses.php?type=C" 
                   class="inline-block px-6 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-colors text-sm">
                    En savoir plus
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-6 border border-gray-100">
                ...
                <a href="/auto-ecole/pages/courses.php?type=D" 
                   class="inline-block px-6 py-2 bg-primary text-white rounded-lg hover:bg-accent transition-colors text-sm">
                    En savoir plus
                </a>
            </div>
...
<footer class="bg-secondary text-white py-12">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h4 class="text-lg font-semibold mb-4">Auto École</h4>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Permis B</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Permis A</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Permis C</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Permis D</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span class="text-gray-400">+212 123-456789</span>
                    </li>
                    <li class="flex items-center space-x-2">
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 text-center">
            <p class="text-gray-400">© 2025 Auto École. Tous droits réservés.</p>
        </div>
    </div>
</footer>
